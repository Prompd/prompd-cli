...
export { findProjectRoot, resolvePackage, resolvePackageFile, isPackageInstalled, parsePackageReference, parsePackageReferenceWithPath, getLocalBaseDir, getGlobalBaseDir } from './package-resolver';
