...
def show():
    ...
    try:
        ...
        raise PrompdError(f"Failed to show configuration: {e}") from e
...
def registry_list():
    ...
    try:
        ...
        raise PrompdError(f"Failed to list registries: {e}") from e
...
def registry_add(name: str, url: str, api_key: Optional[str], set_default: bool):
    ...
    try:
        ...
        raise PrompdError(f"Failed to add registry: {e}") from e
...
def registry_remove(name: str):
    ...
    try:
        ...
        raise PrompdError(f"Failed to remove registry: {e}") from e
...
def registry_set_default(name: str):
    ...
    try:
        ...
        raise PrompdError(f"Failed to set default registry: {e}") from e
...
def registry_show(name: Optional[str]):
    ...
    try:
        ...
        raise PrompdError(f"Failed to show registry: {e}") from e
...
def provider_list():
    ...
    try:
        ...
        raise PrompdError(f"Failed to list providers: {e}") from e
...
def provider_add(name: str, url: str, models: tuple, api_key: Optional[str], enabled: bool):
    ...
    try:
        ...
        raise PrompdError(f"Failed to add provider: {e}") from e
...
def provider_remove(name: str):
    ...
    try:
        ...
        raise PrompdError(f"Failed to remove provider: {e}") from e
...
def provider_setkey(name: str, api_key: str):
    ...
    try:
        ...
        raise PrompdError(f"Failed to set API key: {e}") from e
