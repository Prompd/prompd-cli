...
class PrompdREPL:
            ...
            if metadata.parameters:
                ...
                with Progress(
                    ...
                    try:
                        ...
                        self.console.print("[green]✓[/green] Compiled successfully!")
                ...
                compiler = PrompdCompiler()
                compiler.compile(str(prompt_path), parameters={}, output_format="markdown")
                self.console.print("[green]✓[/green] Compiled successfully!")
    ...
    def interactive_publish(self, args: List[str]):
        ...
        with Progress(
            ...
            try:
                self.registry.publish_package(str(package_path))
                progress.remove_task(task)
