...
class RegistryClient:
        ...
        try:
            ...
            if hasattr(e, "response") and e.response is not None:
                ...
                try:
                    ...
                    error_msg = str(e)
                raise Exception(f"Authentication failed: {error_msg}") from e
    ...
    def get_package_info(self, package_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise Exception(f"Package info fetch failed: {e}") from e
    ...
    def get_package_versions(self, package_name: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            raise Exception(f"Version fetch failed: {e}") from e
    ...
    def publish_package(self, package_path: Path, target_namespace: Optional[str] = None) -> Dict[str, Any]:
        ...
        if package_path.suffix != ".pdpkg":
            raise Exception(
                f"Only .pdpkg package files are supported. Got: {package_path.suffix}."
                " This is a package registry, not a .prmd file registry."
            )
    ...
    def _publish_pdpkg(self, package_path: Path, namespace: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            raise Exception(f"Invalid .pdpkg package: {e}") from e
    ...
    def install_package(
        ...
        try:
            ...
            raise Exception(f"Package download failed: {e}") from e
...
def _extract_pdf_text(pdf_path: Path) -> str:
    ...
    try:
        ...
        return (
            f"[PDF Content from {pdf_path.name}]\n\n"
...
def _extract_docx_text(docx_path: Path) -> str:
    ...
    try:
        ...
        return (
            f"[Word Document from {docx_path.name}]\n\n"
...
def _extract_pptx_text(pptx_path: Path) -> str:
    ...
    try:
        ...
        return (
            f"[PowerPoint Presentation from {pptx_path.name}]\n\n"
...
def _process_excel_file(xlsx_path: Path) -> List[Tuple[str, str]]:
    ...
    try:
        ...
        fallback_content = (
            f"[Excel Workbook from {xlsx_path.name}]\n\n"
