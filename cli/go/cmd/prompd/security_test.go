...
func TestDetectSecretsInContent(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "Anthropic key",
			content:  "sk-ant-api01-aBcDeFgHiJkLmNoPqRsTuVwXyZ0123456789aBcDeFgHiJkLmNoPqRsTuVwXyZ0123456789aBcDeFgHiJkLmNoPqRs",
			expected: 1,
		},
		{
			name:     "AWS access key",
