...
func TestSanitizeFilePath(t *testing.T) {
	tests := []struct {
		...
		{name: "absolute path", path: "/etc/passwd", basePath: "", shouldErr: true},
...
func TestIsSecurePath(t *testing.T) {
	tests := []struct {
		...
		{name: "simple relative", path: "file.txt", basePath: "/tmp", shouldErr: false},
		{name: "relative with dir", path: "dir/file.txt", basePath: "/tmp", shouldErr: false},
		{name: "absolute path", path: "/etc/passwd", basePath: "/tmp", shouldErr: true},
		{name: "traversal up", path: "../etc/passwd", basePath: "/tmp", shouldErr: true},
		{name: "traversal in middle", path: "dir/../../../etc/passwd", basePath: "/tmp", shouldErr: true},
		{name: "null byte", path: "file\x00.txt", basePath: "/tmp", shouldErr: true},
	}
