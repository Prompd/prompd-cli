...
from ..registry import validate_pdpkg
from ..security import SecurityError, validate_file_path
...
def validate_package(package_file: str):
    ...
    try:
        ...
        if not safe_path.suffix == ".pdpkg":
            console.print("[red]File must have .pdpkg extension[/red]")
            return
        ...
        if result["valid"]:
            console.print("[green]✓[/green] Package is valid")
...
"""
            ...
            console.print("[red]✗[/red] Package validation failed")
