...
**Files Created:**
- `cli/npm/src/lib/compiler/types.ts` (217 lines)
- `cli/npm/src/lib/compiler/pipeline.ts` (211 lines)
- `cli/npm/src/lib/errors.ts` (30 lines)
...
**Files Created:**
- `cli/npm/src/lib/compiler/stages/lexical.ts` (42 lines)
- `cli/npm/src/lib/compiler/stages/semantic.ts` (87 lines)
...
**Files Created:**
- `cli/npm/src/lib/compiler/stages/dependency.ts` (296 lines)
- `cli/npm/src/lib/compiler/package-resolver.ts` (142 lines)
...
**File Created:**
- `cli/npm/src/lib/compiler/stages/template.ts` (487 lines)
...
**File Created:**
- `cli/npm/src/lib/compiler/section-override.ts` (314 lines)
...
**File Created:**
- `cli/npm/src/lib/compiler/stages/assets.ts` (295 lines)
...
**Files Created:**
- `cli/npm/src/lib/compiler/formatters/markdown.ts` (74 lines)
- `cli/npm/src/lib/compiler/formatters/openai.ts` (95 lines)
- `cli/npm/src/lib/compiler/formatters/anthropic.ts` (92 lines)
- `cli/npm/src/lib/compiler/stages/codegen.ts` (60 lines)
...
**Files Updated:**
- `cli/npm/src/lib/compiler/index.ts` (127 lines) - Main compiler class
- `cli/npm/src/lib/index.ts` - Library exports
- `cli/npm/src/commands/compile.ts` - CLI integration
- `cli/npm/src/types/index.ts` - Type definitions
